...
export const TARGET_LOCATIONS: LocationTarget[] = [
  ...
  { id: 'meridian-gentry-way', name: 'Meridian, ID', lat: 43.5983436, lng: -116.3567336 },
  { id: 'park-city-center-drive', name: 'Park City, UT', lat: 40.7201349, lng: -111.5390464 },
  { id: 'slc-3000-east', name: 'Salt Lake City, UT', lat: 40.6339463, lng: -111.8067671 },
];
